...
export const en: Dictionary = {
  ...
  budaya: {
    ...
    galleryCaptions: [
      "Woven pendant against a textured wall",
      "Bell-shaped woven pendant",
      "Low-profile woven pendant",
      "Ceramic vase and porcelain pendant",
      "Sculptural vase on a reclaimed wood bench",
      "Ceramic vessel and books on a walnut shelf",
      "Sculptural piece on a travertine base",
      "Woven baskets beside a wooden console",
      "Loungers by the infinity pool",
      "Loungers on a terrace among the trees",
      "Loungers facing the sunset over the sea",
      "Wooden tray with glasses and wine",
      "Sculptural pendant in wood veneer",
      "Teak armchair on a gravel garden",
      "Acapulco chair and side table in the shade",
      "Outdoor lounge with lanterns and Acapulco chairs",
      "Hanging chair by the window",
      "Bedroom with hanging chair and white bed linen",
      "Outdoor dining under a wooden pergola",
      "Bathroom with a natural fibre pendant",
      "Pendant made of wooden slats",
      "Oval woven pendant",
      "Fibre pendant with a wrapping form",
      "Dome-shaped woven pendant",
      "Pendant made of bamboo rods",
      "Cylindrical woven pendant",
      "Fibre pendant with a wing-like silhouette",
      "Woven pendant with a double curve",
      "Flat fibre pendant casting shadows on the wall",
      "White bed linen over natural weave",
      "Towels and soap dish on a wooden bench",
      "Woven pendant with an open weave",
      "Bathroom with freestanding tub and jute rug",
      "Entrance hall with vessels and a round rug",
    ],
