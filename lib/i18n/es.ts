...
export const es = {
  ...
  budaya: {
    ...
    /** Una descripcion breve por foto, en el mismo orden que budayaGallery. */
    galleryCaptions: [
      "Colgante tejido sobre muro texturado",
      "Colgante tejido en forma de campana",
      "Colgante tejido de perfil bajo",
      "Jarrón de cerámica y colgante de porcelana",
      "Jarrón escultórico sobre banco de madera recuperada",
      "Vasija de cerámica y libros sobre repisa de nogal",
      "Pieza escultórica sobre base de travertino",
      "Cestas tejidas junto a consola de madera",
      "Camastros frente a la piscina infinita",
      "Camastros en terraza entre árboles",
      "Camastros frente al atardecer sobre el mar",
      "Bandeja de madera con copas y vino",
      "Colgante escultórico en chapa de madera",
      "Sillón de teca sobre jardín de piedra",
      "Silla Acapulco y mesa auxiliar a la sombra",
      "Estar exterior con faroles y sillas Acapulco",
      "Silla hamaca frente al ventanal",
      "Habitación con silla hamaca y ropa de cama blanca",
      "Comedor exterior bajo pérgola de madera",
      "Baño con colgante de fibra natural",
      "Colgante de listones de madera",
      "Colgante tejido ovalado",
      "Colgante de fibra con forma envolvente",
      "Colgante tejido en cúpula",
      "Colgante de varillas de bambú",
      "Colgante tejido cilíndrico",
      "Colgante de fibra con silueta de ala",
      "Colgante tejido de doble curva",
      "Colgante plano de fibra y sombras sobre el muro",
      "Ropa de cama blanca sobre tejido natural",
      "Toallas y jabonera sobre banco de madera",
      "Colgante tejido de trama abierta",
      "Baño con tina exenta y tapete de yute",
      "Vestíbulo con vasijas y tapete redondo",
    ],
